...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xbbf737b45f9649c267619f9abae28b400c086632a11110ffc377bde5a5eb051f"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2a89d02d4268119ad31e3eef4ae66c8fcb546f8a32e591b637470df495a821b"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(
            ...
            0x2000ffff, 4, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7085251a57bc16dc743c676c99b63a25dd4f007704e8ff318f64b48b30b3d0ee"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2a89d02d4268119ad31e3eef4ae66c8fcb546f8a32e591b637470df495a821b"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(
            ...
            0x200f0f0f, 4, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbc9bb6031ea3dc0f0bd94c4ee35a7befc7a42469464546cda02a6681e4c92176"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2a89d02d4268119ad31e3eef4ae66c8fcb546f8a32e591b637470df495a821b"));
