...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Juno Cash junocash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  junocash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Juno Cash transaction") + "\n" +
              "  junocash-tx [options] -create [commands]   " + _("Create hex-encoded Juno Cash transaction") + "\n" +
              "\n";
