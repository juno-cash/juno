...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric, optional) the total Juno Cash balance of the wallet, if wallet functionality is enabled\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"junocashaddress\"\n"
            "\nReturn information about the given Juno Cash address.\n"
            "\nArguments:\n"
            "1. \"junocashaddress\"     (string, required) The Juno Cash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"junocashaddress\",   (string) The Juno Cash address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are Juno Cash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) Juno Cash address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"junocashaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"junocashaddress\"    (string, required) The Juno Cash address to use for the signature.\n"
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    ...
    if (!(fExperimentalInsightExplorer || fExperimentalLightWalletd)) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressmempool is disabled. "
            "Run './junocash-cli help getaddressmempool' for instructions on how to enable this feature.");
    }
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    ...
    if (!(fExperimentalInsightExplorer || fExperimentalLightWalletd)) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressutxos is disabled. "
            "Run './junocash-cli help getaddressutxos' for instructions on how to enable this feature.");
    }
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    ...
    if (!(fExperimentalInsightExplorer || fExperimentalLightWalletd)) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressdeltas is disabled. "
            "Run './junocash-cli help getaddressdeltas' for instructions on how to enable this feature.");
    }
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    ...
    if (!(fExperimentalInsightExplorer || fExperimentalLightWalletd)) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddressbalance is disabled. "
            "Run './junocash-cli help getaddressbalance' for instructions on how to enable this feature.");
    }
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    ...
    if (!(fExperimentalInsightExplorer || fExperimentalLightWalletd)) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getaddresstxids is disabled. "
            "Run './junocash-cli help getaddresstxids' for instructions on how to enable this feature.");
    }
...
UniValue getspentinfo(const UniValue& params, bool fHelp)
{
    ...
    if (!fExperimentalInsightExplorer) {
        throw JSONRPCError(RPC_MISC_ERROR, "Error: getspentinfo is disabled. "
            "Run './junocash-cli help getspentinfo' for instructions on how to enable this feature.");
    }
