...
$(package)_download_path_aarch64_darwin=https://github.com/llvm/llvm-project/releases/download/llvmorg-$($(package)_version)
$(package)_download_file_aarch64_darwin=clang+llvm-$($(package)_version)-arm64-apple-darwin21.0.tar.xz
$(package)_file_name_aarch64_darwin=clang-llvm-$($(package)_version)-arm64-apple-darwin21.0.tar.xz
